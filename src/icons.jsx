const ReplyIcon = ({color,height,width}) =>{
    return (
        <svg fill={color || '#fff'} width={width|| 24} height={height || 24} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
...
const CommentIcon =({color,height,width})=> {
    return(
<>
    <svg fill={color || '#fff'} width={width|| 24} height={height || 24} viewBox="0 0 24 24" aria-hidden="true"
       >
...
const LikeIcon =({color,height,width})=> {
    return(
        <>
            <svg fill={color || '#fff'} width={width|| 24} height={height || 24} viewBox="0 0 24 24" aria-hidden="true"
                >
...
const SaveIcon =({color,height,width})=> {
    return(
        <>
            <svg fill={color || '#fff'} width={width|| 24} height={height || 24}  viewBox="0 0 24 24" aria-hidden="true">
                <g>
...
const VerifiedIcon =({color,height,width})=> {
    return(
        <>
            <svg fill={color || '#fff'} width={width|| 24} height={height || 24}  viewBox="0 0 22 22" aria-label="Verified account" role="img">
...
export {ReplyIcon, CommentIcon, LikeIcon, SaveIcon , VerifiedIcon}
